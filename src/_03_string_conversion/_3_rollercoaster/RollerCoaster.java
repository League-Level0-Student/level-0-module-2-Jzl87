...
public class RollerCoaster {
	...
	// 1) Make a main method that includes all the steps below…. 
		public static void main(String[] args) {
			...
			int heightInt = Integer.parseInt(heightToRide);
		
		// 2) Ask the user to enter their height in inches using JOptionPane and set it to the variable heightToRide
		
		if( heightInt >= 48 ) { ;
		JOptionPane.showMessageDialog(null, "HURRAY! You are tall enough for this ride");
		// Do you see the heightToRide > 42 underlined red? That is because you are comparing a STRING to an INTEGER.
			...
			JOptionPane.showMessageDialog(null, "You must ride with someone else.");
		} else {
			JOptionPane.showMessageDialog(null, "Sorry bucko, you arent all enough, better luck next time.");
		}
